...
layout: docs
title: Crow and Vite
description: The official guide for how to include and bundle Crow's CSS and JavaScript in your project using Vite.
group: getting-started
toc: true
thumbnail: guides/crow-vite@2x.png
---

<img class="mb-4 img-fluid rounded-3" srcset="/docs/{{< param docs_version >}}/assets/img/guides/crow-vite.png, /docs/{{< param docs_version >}}/assets/img/guides/crow-vite@2x.png 2x" src="/docs/{{< param docs_version >}}/assets/img/guides/crow-vite.png" width="2000" height="1000" alt="">

{{< callout >}}
**Want to skip to the end?** Download the source code and working demo for this guide from the [ecossistemadev/examples repository](https://github.com/ecossistemadev/examples/tree/main/vite). You can also [open the example in StackBlitz](https://stackblitz.com/github/ecossistemadev/examples/tree/main/vite?file=index.html) for live editing.
{{< /callout >}}

## Setup

We're building a Vite project with Crow from scratch, so there are some prerequisites and upfront steps before we can really get started. This guide requires you to have Node.js installed and some familiarity with the terminal.
...
4. **Install additional dependency.** In addition to Vite and Crow, we need another dependency (Sass) to properly import and bundle Crow's CSS.

   ```sh
   npm i --save-dev sass
   ```

Now that we have all the necessary dependencies installed and set up, we can get to work creating the project files and importing Crow.
