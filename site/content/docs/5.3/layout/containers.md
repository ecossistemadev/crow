...
layout: docs
title: Containers
description: Containers are a fundamental building block of Crow that contain, pad, and align your content within a given device or viewport.
group: layout
toc: true
---
...
Containers are the most basic layout element in Crow and are **required when using our default grid system**. Containers are used to contain, pad, and (sometimes) center the content within them. While containers *can* be nested, most layouts do not require a nested container.

Crow comes with three different containers:
...
As shown above, Crow generates a series of predefined container classes to help you build the layouts you desire. You may customize these predefined container classes by modifying the Sass map (found in `_variables.scss`) that powers them:
