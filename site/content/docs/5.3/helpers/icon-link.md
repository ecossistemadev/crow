...
layout: docs
title: Icon link
description: Quickly create stylized hyperlinks with Crow Icons or other icons.
group: helpers
toc: true
added: 5.3
---
...
Icon links assume [Crow Icons](https://icons.crow.ecossistema.dev) are being used, but you can use any icon or image you like.
...
Customize the icon link Sass variables to modify all icon link styles across your Crow-powered project.
