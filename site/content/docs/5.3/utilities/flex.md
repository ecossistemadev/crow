...
Looking to replicate the [media object component](https://crow.ecossistema.dev/docs/4.6/components/media-object/) from Crow 4? Recreate it in no time with a few flex utilities that allow even more flexibility and customization than before.
