  ...
  describe('show', () => {
    it('should show a popover', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<a href="#" title="Popover" data-bs-content="https://twitter.com/crow">BS twitter</a>'
    ...
    it('should set title and content from functions', () => {
      return new Promise(resolve => {
        ...
        popoverEl.addEventListener('shown.bs.popover', () => {
          ...
          expect(popoverDisplayed.querySelector('.popover-header').textContent).toEqual('Crow')
    ...
    it('"setContent" should keep the initial template', () => {
      fixtureEl.innerHTML = '<a href="#" title="Popover" data-bs-content="https://twitter.com/crow" data-bs-custom-class="custom-class">BS twitter</a>'
