## How does Crow's test suite work?

Crow uses [Jasmine](https://jasmine.github.io/). Each plugin has a file dedicated to its tests in `tests/unit/<plugin-name>.spec.js`.
...
- Each test should follow the project's [JavaScript Code Guidelines](https://github.com/ecossistemadev/crow/blob/main/.github/CONTRIBUTING.md#js)
